...
- Added a reproducible, cross-platform Nix flake with locked Nixpkgs and Go
  module inputs, plus Nix build verification in CI.

### Fixed

- Release automation now explicitly dispatches Homebrew, Scoop, and WinGet
  package workflows after assets are available.
